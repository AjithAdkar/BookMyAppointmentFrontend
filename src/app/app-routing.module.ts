...
const routes: Routes = [
      ...
      { path: 'add-patient',  loadChildren: () => import('./add-patients/add-patients.module').then( m=> m.AddPatientsModule)},
      { path: 'show-doctor-details', loadChildren: () => import('./doctor-registration/doctor-registration.module').then(m => m.DoctorRegistrationModule)},
    ];
@NgModule({
